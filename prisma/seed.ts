...
async function seedDatabase() {
  try {
    ...
    // Emails fictícios para as barbearias
    const emails = [
      "contato@barbeariavintage.com",
      "contato@corteestilo.com",
      "contato@barbanavalha.com",
      "contato@dapperden.com",
      "contato@cabelocia.com",
      "contato@machadotesoura.com",
      "contato@barbeariaelegance.com",
      "contato@aparenciaimpecavel.com",
      "contato@estilourbano.com",
      "contato@estiloclassico.com",
    ];
